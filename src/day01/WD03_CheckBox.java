...
public class WD03_CheckBox {
	...
	public static void main(String[] args) {
		...
		oWd.get("http://www.echoecho.com/htmlforms09.htm");
		if(oWd.findElement(By.xpath("//td[@class='table5']/input[3]")).isSelected()==false)
		{
			oWd.findElement(By.xpath("//td[@class='table5']/input[3]")).click();
		}
		else
		{
