...
public class WD03_GetAttributeDetails {
	...
	public static void main(String[] args) {
		...
		System.out.println("Linkname:"+oWd.findElement(By.xpath("//div[@id='nav-xshop']/a[3]")).getText());
		System.out.println("Tagname:"+oWd.findElement(By.xpath("//div[@id='nav-xshop']/a[3]")).getTagName());
		System.out.println("CSSValue:"+oWd.findElement(By.xpath("//div[@id='nav-xshop']/a[3]")).getLocation().getX());
		System.out.println("CSSValue:"+oWd.findElement(By.xpath("//div[@id='nav-xshop']/a[3]")).getLocation().getY());
